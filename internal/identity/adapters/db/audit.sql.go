...
func (q *Queries) ListAuditEventsByTenantPage(ctx context.Context, arg ListAuditEventsByTenantPageParams) ([]BuildingblocksAuditLogEntry, error) {
	rows, err := q.db.Query(ctx, listAuditEventsByTenantPage, arg.TenantID, arg.BeforeOccurred, arg.BeforeID, arg.Limit)
	if err != nil {
		return nil, err
	}
	defer rows.Close()
...
func (q *Queries) ListAuditEventsByUserPage(ctx context.Context, arg ListAuditEventsByUserPageParams) ([]BuildingblocksAuditLogEntry, error) {
	rows, err := q.db.Query(ctx, listAuditEventsByUserPage, arg.UserID, arg.BeforeOccurred, arg.BeforeID, arg.Limit)
	if err != nil {
		return nil, err
	}
	defer rows.Close()
