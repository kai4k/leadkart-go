...
//
//nolint:gochecknoglobals // arch-test registry mirror of identity/crm catalogue
var allEvents []Event

// register appends e to the catalogue + returns it unchanged so the
// caller can write a single-line var block:
//
//	var _ = register(ConsignmentNoteCreatedV1{})
